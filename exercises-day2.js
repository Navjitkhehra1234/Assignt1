...
var newRect = rect.height;
console.log("newRect :" + newRect);
var accessX = rect.x;
var accessY = rect.y;
var accessWidth = rect.width;


//8. console.log the rectangle's area (width * height). Use *dot notation* to access the properties!
console.log("Rectangle's area :" + rect.width * rect.height);
...
var shapes = {
    rect : {x : 30, y :50, width :100, height :50},
    circle : {cx : 34, cy : 43, radius : 7 },
    triangle : {base : 33, height : 44}
} ;
console.log(shapes);
...
var shapes = {
    rect : {x : 30, y :50, width :100, height :50},
    circle : {cx : 34, cy : 43, radius : 7 },
    triangle : {base : 33, height : 44, hypotenuse : Math.sqrt(Math.pow(33,2) + Math.pow(44,2))}
} ;
console.log(shapes);
